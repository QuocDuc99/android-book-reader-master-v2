 ...
 * 时间:              上午9:08:14
 */
package com.github.axet.bookreader.office.common.pictureefftect;
...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(com.github.axet.bookreader.office.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
