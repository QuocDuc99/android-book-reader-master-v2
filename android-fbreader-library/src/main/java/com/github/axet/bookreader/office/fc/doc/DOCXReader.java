...
import com.github.axet.bookreader.office.common.autoshape.AutoShapeDataKit;
...
import com.github.axet.bookreader.office.common.autoshape.pathbuilder.LineArrowPathBuilder;
...
import com.github.axet.bookreader.office.common.bg.PatternShader;
...
import com.github.axet.bookreader.office.common.pictureefftect.PictureEffectInfo;
...
import com.github.axet.bookreader.office.common.shape.WPChartShape;
...
import com.github.axet.bookreader.office.common.shape.WatermarkShape;
import com.github.axet.bookreader.office.constant.MainConstant;
import com.github.axet.bookreader.office.constant.SchemeClrConstant;
...
import com.github.axet.bookreader.office.fc.LineKit;
import com.github.axet.bookreader.office.fc.ShapeKit;
import com.github.axet.bookreader.office.fc.dom4j.Document;
import com.github.axet.bookreader.office.fc.dom4j.Element;
import com.github.axet.bookreader.office.fc.dom4j.ElementHandler;
import com.github.axet.bookreader.office.fc.dom4j.ElementPath;
import com.github.axet.bookreader.office.fc.dom4j.io.SAXReader;
import com.github.axet.bookreader.office.fc.openxml4j.exceptions.InvalidFormatException;
import com.github.axet.bookreader.office.fc.openxml4j.opc.PackagePart;
import com.github.axet.bookreader.office.fc.openxml4j.opc.PackageRelationship;
import com.github.axet.bookreader.office.fc.openxml4j.opc.PackageRelationshipTypes;
import com.github.axet.bookreader.office.fc.openxml4j.opc.ZipPackage;
import com.github.axet.bookreader.office.fc.ppt.reader.ReaderKit;
import com.github.axet.bookreader.office.fc.ppt.reader.ThemeReader;
import com.github.axet.bookreader.office.fc.xls.Reader.drawing.ChartReader;
...
import com.github.axet.bookreader.office.simpletext.model.Style;
import com.github.axet.bookreader.office.simpletext.model.StyleManage;
...
public class DOCXReader extends AbstractReader {
    ...
    private void openFile() throws Exception {
        ...
        Log.d("ducNQ", "openFileffff: "+filePath);
        ...
        if (zipPackage.getParts().size() == 0) {
            coreRel = zipPackage.getRelationshipsByType(
                    PackageRelationshipTypes.CORE_DOCUMENT2).getRelationship(0);
            Log.d("ducNQ", "openFiled: 1");
            // throw new Exception("Format error");
        }

        if (!coreRel.getTargetURI().toString().equals("/word/document.xml")) {
            Log.d("ducNQ", "openFiled: 2");
            throw new Exception("Format error");
        }
