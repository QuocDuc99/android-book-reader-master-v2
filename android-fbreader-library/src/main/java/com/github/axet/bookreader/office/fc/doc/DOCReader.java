...
package com.github.axet.bookreader.office.fc.doc;
...
import com.github.axet.bookreader.office.common.bookmark.Bookmark;
import com.github.axet.bookreader.office.common.borders.Border;
import com.github.axet.bookreader.office.common.borders.Borders;
import com.github.axet.bookreader.office.common.borders.Line;
import com.github.axet.bookreader.office.common.bulletnumber.ListData;
import com.github.axet.bookreader.office.common.bulletnumber.ListLevel;
import com.github.axet.bookreader.office.common.hyperlink.Hyperlink;
import com.github.axet.bookreader.office.common.picture.Picture;
...
import com.github.axet.bookreader.office.common.shape.WPAbstractShape;
import com.github.axet.bookreader.office.common.shape.WPAutoShape;
import com.github.axet.bookreader.office.common.shape.WPGroupShape;
import com.github.axet.bookreader.office.common.shape.WPPictureShape;
...
import com.github.axet.bookreader.office.fc.ddf.EscherContainerRecord;
import com.github.axet.bookreader.office.fc.ddf.EscherOptRecord;
import com.github.axet.bookreader.office.fc.ddf.EscherProperties;
import com.github.axet.bookreader.office.fc.ddf.EscherSimpleProperty;
import com.github.axet.bookreader.office.fc.ddf.EscherTextboxRecord;
import com.github.axet.bookreader.office.fc.hwpf.HWPFDocument;
import com.github.axet.bookreader.office.fc.hwpf.model.FieldsDocumentPart;
import com.github.axet.bookreader.office.fc.hwpf.model.ListFormatOverride;
import com.github.axet.bookreader.office.fc.hwpf.model.ListTables;
import com.github.axet.bookreader.office.fc.hwpf.model.POIListData;
import com.github.axet.bookreader.office.fc.hwpf.model.POIListLevel;
import com.github.axet.bookreader.office.fc.hwpf.model.PicturesTable;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.Bookmarks;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.BorderCode;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.CharacterRun;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.Field;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.HWPFAutoShape;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.HWPFShape;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.HWPFShapeGroup;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.HeaderStories;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.InlineWordArt;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.OfficeDrawing;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.OfficeDrawings;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.POIBookmark;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.Paragraph;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.PictureType;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.Range;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.Section;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.Table;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.TableCell;
import com.github.axet.bookreader.office.fc.hwpf.usermodel.TableRow;
import com.github.axet.bookreader.office.fc.util.LittleEndian;
import com.github.axet.bookreader.office.java.awt.Rectangle;
import com.github.axet.bookreader.office.java.util.Arrays;
...
import com.github.axet.bookreader.office.simpletext.model.IElement;
...
import com.github.axet.bookreader.office.simpletext.view.PageAttr;
import com.github.axet.bookreader.office.ss.util.ModelUtil;
import com.github.axet.bookreader.office.system.AbstractReader;
import com.github.axet.bookreader.office.system.IControl;
import com.github.axet.bookreader.office.wp.model.CellElement;
import com.github.axet.bookreader.office.wp.model.HFElement;
import com.github.axet.bookreader.office.wp.model.RowElement;
import com.github.axet.bookreader.office.wp.model.TableElement;
import com.github.axet.bookreader.office.wp.model.WPDocument;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.github.axet.bookreader.office.java.awt.Color fillColor = shape.getForegroundColor();
            	com.github.axet.bookreader.office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.github.axet.bookreader.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.github.axet.bookreader.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
