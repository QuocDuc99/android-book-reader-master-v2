...
import com.github.axet.bookreader.office.system.FileReaderThread;
import com.github.axet.bookreader.office.system.IControl;
import com.github.axet.bookreader.office.system.IDialogAction;
import com.github.axet.bookreader.office.thirdpart.mozilla.intl.chardet.CharsetDetector;
            ...
            if(control.getMainFrame().isShowTXTEncodeDlg())
            {
                ...
                {                    
                    ...
                    public void doAction(int id, Vector<Object> model)
                    {
                        ...
                        {
                            control.getMainFrame().getActivityIMain().onBackPressed();
                        }
                        else
                        {
                ...
                new TXTEncodingDialog(control, control.getMainFrame().getActivityIMain(), da,
