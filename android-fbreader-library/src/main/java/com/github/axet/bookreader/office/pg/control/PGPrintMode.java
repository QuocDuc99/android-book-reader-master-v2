 ...
 * 时间:              上午10:53:24
 */
package com.github.axet.bookreader.office.pg.control;
...
import com.github.axet.bookreader.office.pg.view.SlideDrawKit;
...
import com.github.axet.bookreader.office.system.IMainFrame;
import com.github.axet.bookreader.office.system.SysKit;
import com.github.axet.bookreader.office.system.beans.pagelist.APageListItem;
import com.github.axet.bookreader.office.system.beans.pagelist.APageListView;
import com.github.axet.bookreader.office.system.beans.pagelist.IPageListViewListener;
...
public class PGPrintMode extends FrameLayout implements IPageListViewListener
{
     ...
     *
     */
    public PGPrintMode(Context context, IControl control, PGModel pgModel, PGEditor editor, OnChangePageDocumentListener onChangePageDocumentListener)
    {
        super(context);
    ...
    protected void dispatchDraw(Canvas canvas) 
    {
        super.dispatchDraw(canvas);
            if(listView.getCurrentPageNumber() !=pageOld){
                pageOld = listView.getCurrentPageNumber();
                if(onChangePageDocumentListener!=null) onChangePageDocumentListener.changePage(pageOld, pgModel.getSlideCount());
            }
