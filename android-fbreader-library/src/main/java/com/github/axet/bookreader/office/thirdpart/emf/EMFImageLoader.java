...
import com.github.axet.bookreader.office.thirdpart.emf.data.BitmapInfoHeader;
import com.github.axet.bookreader.office.thirdpart.emf.data.BlendFunction;
...
public class EMFImageLoader {
    ...
    public static Bitmap readImage(
        ...
        if (bmi.getBitCount() == 1) {
            ...
            f.setSize(new com.github.axet.bookreader.office.java.awt.Dimension(width + 20, height + 20));
            f.setVisible(true);*/
