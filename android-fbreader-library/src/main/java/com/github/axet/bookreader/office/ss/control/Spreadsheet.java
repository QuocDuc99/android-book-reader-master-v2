...
package com.github.axet.bookreader.office.ss.control;
...
import com.github.axet.bookreader.office.ss.model.interfacePart.IReaderListener;
import com.github.axet.bookreader.office.ss.util.ModelUtil;
import com.github.axet.bookreader.office.ss.view.SheetView;
...
import com.github.axet.bookreader.office.system.beans.AEventManage;
...
//    }
     ...
     *(non-Javadoc)
     * @see com.github.axet.bookreader.office.ss.model.interfacePart.IReaderListener#OnReadingFinished()
     *
     */
    public void OnReadingFinished()
    { 
       
        if(control != null && control.getMainFrame().getActivityIMain() != null)
        {  
            post(new Runnable()
            {
                public void run()
