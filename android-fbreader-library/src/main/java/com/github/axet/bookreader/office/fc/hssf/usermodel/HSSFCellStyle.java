...
import com.github.axet.bookreader.office.fc.ss.usermodel.IFont;
 ...
 * @see com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFCell#setCellStyle(HSSFCellStyle)
 */
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @see com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFDataFormat
     */
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(com.github.axet.bookreader.office.fc.ss.usermodel.Workbook workbook) {
     ...
     * @see com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFDataFormat
     */
    public String getDataFormatString(com.github.axet.bookreader.office.fc.hssf.model.InternalWorkbook workbook)
    {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFWorkbook#createFont()
     * @see com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
     ...
     * @see com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFCellStyle#getFontIndex()
     * @see com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(com.github.axet.bookreader.office.fc.ss.usermodel.Workbook parentWorkbook) {
     ...
     * @see com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFPalette#getColor(short)
    ...
    private void checkDefaultBackgroundFills() {
      if (_format.getFillForeground() == com.github.axet.bookreader.office.fc.hssf.util.HSSFColor.AUTOMATIC.index) {
    	  ...
    	  if (_format.getFillBackground() != (com.github.axet.bookreader.office.fc.hssf.util.HSSFColor.AUTOMATIC.index+1))
    		  setFillBackgroundColor((short)(com.github.axet.bookreader.office.fc.hssf.util.HSSFColor.AUTOMATIC.index+1));
      } else if (_format.getFillBackground() == com.github.axet.bookreader.office.fc.hssf.util.HSSFColor.AUTOMATIC.index+1)
    	  //Now if the forground changes to a non-AUTOMATIC color the background resets itself!!!
    	  if (_format.getFillForeground() != com.github.axet.bookreader.office.fc.hssf.util.HSSFColor.AUTOMATIC.index)
    		  setFillBackgroundColor(com.github.axet.bookreader.office.fc.hssf.util.HSSFColor.AUTOMATIC.index);
    }
