...
import com.github.axet.bookreader.office.pg.view.SlideShowView;
...
import com.github.axet.bookreader.office.system.beans.CalloutView.CalloutView;
import com.github.axet.bookreader.office.system.beans.CalloutView.IExportListener;
...
public class Presentation extends FrameLayout implements IFind, IExportListener
{
     ...
     * 
     */
    public Presentation(Activity activity, PGModel pgModel, IControl control, OnChangePageDocumentListener onChangePageDocumentListener)
    {
        super(activity);
        ...
        //
        pgPrintMode = new PGPrintMode(activity, control, pgModel, editor, onChangePageDocumentListener);
        //
        addView(pgPrintMode);
    }
