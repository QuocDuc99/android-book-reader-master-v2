 ...
 * 时间:              下午5:45:18
 */
package com.github.axet.bookreader.office.pdf;
...
import com.github.axet.bookreader.office.fc.pdf.PDFHyperlinkInfo;
...
public class PDFControl extends AbstractControl
{
    ...
    public PDFControl(IControl mainControl, PDFLib pdfLib, String filePath)
    {
        ...
        pdfView = new PDFView(mainControl.getMainFrame().getActivityIMain().getApplicationContext(), pdfLib, this);
    }
