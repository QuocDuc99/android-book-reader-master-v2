 ...
 * 时间:              下午6:08:08
 */
package com.github.axet.bookreader.office.fc.xls.Reader;
...
import com.github.axet.bookreader.office.fc.xls.Reader.drawing.DrawingReader;
import com.github.axet.bookreader.office.fc.xls.Reader.table.TableReader;
...
import com.github.axet.bookreader.office.ss.model.sheetProperty.ColumnInfo;
...
public class SheetReader
{
    ...
    public  void getSheet(IControl control, ZipPackage zipPackage, Sheet sheet, PackagePart  sheetPart, IReader iReader) throws Exception
    {
        ...
        if(ele.element("pane") != null)
        {
           ...
           {
               String s = pane.attributeValue("xSplit");
               if(s.contains(".")){
                   s = s.substring(0,s.indexOf("."));
               }
               paneInfo.setVerticalSplitLeftColumn((short)Integer.parseInt(s));
           }
           
           if(pane.attributeValue("ySplit") != null)
           {
               String s = pane.attributeValue("ySplit");
               if(s.contains(".")){
                   s = s.substring(0,s.indexOf("."));
               }
               paneInfo.setHorizontalSplitTopRow((short)Integer.parseInt(s));
           }
