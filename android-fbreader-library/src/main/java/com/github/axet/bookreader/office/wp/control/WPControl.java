...
import com.github.axet.bookreader.office.wp.dialog.TXTEncodingDialog;
...
public class WPControl extends AbstractControl
{
    ...
    public WPControl(IControl mainControl, IDocument doc, String filePath, OnChangePageDocumentListener onChangePageDocumentListener)
    {
        this.mainControl = mainControl;
        wpView = new Word(mainControl.getMainFrame().getActivityIMain().getApplicationContext(), doc, filePath, this, onChangePageDocumentListener);
    }
    ...
    public void changePage(int index){
        if(wpView!=null){
            wpView.showPage(index, EventConstant.WP_SHOW_PAGE);
        }
    }
                ...
                {                    
                    try
                    {
                        ...
                        else
                        {
                            ...
                            getMainFrame().getActivityIMain().startActivity(intent);
                        }
                    }
                    catch(Exception e)
                    {
    ...
    {
        return getMainFrame().getActivityIMain();
    }
