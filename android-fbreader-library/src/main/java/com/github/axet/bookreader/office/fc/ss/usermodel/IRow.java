...
public interface IRow extends Iterable<ICell> {
     ...
     * @see #getCell(int, com.com.github.axet.bookreader.office.fc.ss.usermodel.IRow.MissingCellPolicy)
     */
    ICell getCell(int cellnum);
    
    /**
     * Returns the cell at the given (0 based) index, with the specified {@link com.com.github.axet.bookreader.office.fc.ss.usermodel.IRow.MissingCellPolicy}
     *
