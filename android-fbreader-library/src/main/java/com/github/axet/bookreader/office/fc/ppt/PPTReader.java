 ...
 * 时间:               下午4:23:51
 */
package com.github.axet.bookreader.office.fc.ppt;
...
import com.github.axet.bookreader.office.common.PaintKit;
import com.github.axet.bookreader.office.common.autoshape.ExtendPath;
import com.github.axet.bookreader.office.common.autoshape.pathbuilder.ArrowPathAndTail;
import com.github.axet.bookreader.office.common.bg.BackgroundAndFill;
import com.github.axet.bookreader.office.common.bg.Gradient;
import com.github.axet.bookreader.office.common.bg.LinearGradientShader;
import com.github.axet.bookreader.office.common.bg.RadialGradientShader;
import com.github.axet.bookreader.office.common.bg.TileShader;
import com.github.axet.bookreader.office.common.hyperlink.Hyperlink;
import com.github.axet.bookreader.office.common.pictureefftect.PictureEffectInfoFactory;
import com.github.axet.bookreader.office.common.shape.AbstractShape;
import com.github.axet.bookreader.office.common.shape.ArbitraryPolygonShape;
import com.github.axet.bookreader.office.common.shape.Arrow;
import com.github.axet.bookreader.office.common.shape.AutoShape;
import com.github.axet.bookreader.office.common.shape.GroupShape;
import com.github.axet.bookreader.office.common.shape.IShape;
import com.github.axet.bookreader.office.common.shape.LineShape;
import com.github.axet.bookreader.office.common.shape.PictureShape;
import com.github.axet.bookreader.office.common.shape.ShapeTypes;
import com.github.axet.bookreader.office.common.shape.TableCell;
import com.github.axet.bookreader.office.common.shape.TableShape;
import com.github.axet.bookreader.office.common.shape.TextBox;
import com.github.axet.bookreader.office.constant.AutoShapeConstant;
import com.github.axet.bookreader.office.constant.EventConstant;
import com.github.axet.bookreader.office.constant.MainConstant;
import com.github.axet.bookreader.office.constant.wp.WPAttrConstant;
import com.github.axet.bookreader.office.constant.wp.WPModelConstant;
import com.github.axet.bookreader.office.fc.FCKit;
import com.github.axet.bookreader.office.fc.ShapeKit;
import com.github.axet.bookreader.office.fc.hslf.HSLFSlideShow;
import com.github.axet.bookreader.office.fc.hslf.model.Fill;
import com.github.axet.bookreader.office.fc.hslf.model.HeadersFooters;
import com.github.axet.bookreader.office.fc.hslf.model.Line;
import com.github.axet.bookreader.office.fc.hslf.model.MasterSheet;
import com.github.axet.bookreader.office.fc.hslf.model.Notes;
import com.github.axet.bookreader.office.fc.hslf.model.Shape;
import com.github.axet.bookreader.office.fc.hslf.model.ShapeGroup;
import com.github.axet.bookreader.office.fc.hslf.model.Sheet;
import com.github.axet.bookreader.office.fc.hslf.model.SimpleShape;
import com.github.axet.bookreader.office.fc.hslf.model.Slide;
import com.github.axet.bookreader.office.fc.hslf.model.SlideMaster;
import com.github.axet.bookreader.office.fc.hslf.model.TextShape;
import com.github.axet.bookreader.office.fc.hslf.model.TitleMaster;
import com.github.axet.bookreader.office.fc.hslf.record.BinaryTagDataBlob;
import com.github.axet.bookreader.office.fc.hslf.record.ClientVisualElementContainer;
import com.github.axet.bookreader.office.fc.hslf.record.DocumentAtom;
import com.github.axet.bookreader.office.fc.hslf.record.OEPlaceholderAtom;
import com.github.axet.bookreader.office.fc.hslf.record.PositionDependentRecordContainer;
import com.github.axet.bookreader.office.fc.hslf.record.Record;
import com.github.axet.bookreader.office.fc.hslf.record.SlideAtom;
import com.github.axet.bookreader.office.fc.hslf.record.SlideProgBinaryTagContainer;
import com.github.axet.bookreader.office.fc.hslf.record.SlideProgTagsContainer;
import com.github.axet.bookreader.office.fc.hslf.record.SlideShowSlideInfoAtom;
import com.github.axet.bookreader.office.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.github.axet.bookreader.office.fc.hslf.record.TimeBehaviorContainer;
import com.github.axet.bookreader.office.fc.hslf.record.TimeColorBehaviorContainer;
import com.github.axet.bookreader.office.fc.hslf.record.TimeCommandBehaviorContainer;
import com.github.axet.bookreader.office.fc.hslf.record.TimeEffectBehaviorContainer;
import com.github.axet.bookreader.office.fc.hslf.record.TimeMotionBehaviorContainer;
import com.github.axet.bookreader.office.fc.hslf.record.TimeNodeAttributeContainer;
import com.github.axet.bookreader.office.fc.hslf.record.TimeNodeContainer;
import com.github.axet.bookreader.office.fc.hslf.record.TimeRotationBehaviorContainer;
import com.github.axet.bookreader.office.fc.hslf.record.TimeScaleBehaviorContainer;
import com.github.axet.bookreader.office.fc.hslf.record.TimeSetBehaviorContainer;
import com.github.axet.bookreader.office.fc.hslf.record.TimeVariant;
import com.github.axet.bookreader.office.fc.hslf.record.VisualShapeAtom;
import com.github.axet.bookreader.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.github.axet.bookreader.office.fc.hslf.usermodel.PictureData;
import com.github.axet.bookreader.office.fc.hslf.usermodel.RichTextRun;
import com.github.axet.bookreader.office.fc.hslf.usermodel.SlideShow;
import com.github.axet.bookreader.office.fc.ppt.bulletnumber.BulletNumberManage;
import com.github.axet.bookreader.office.fc.ss.usermodel.Textbox;
import com.github.axet.bookreader.office.java.awt.Dimension;
import com.github.axet.bookreader.office.java.awt.Rectangle;
import com.github.axet.bookreader.office.java.awt.Rectanglef;
import com.github.axet.bookreader.office.java.awt.geom.Rectangle2D;
import com.github.axet.bookreader.office.pg.animate.ShapeAnimation;
import com.github.axet.bookreader.office.pg.model.PGModel;
import com.github.axet.bookreader.office.pg.model.PGNotes;
import com.github.axet.bookreader.office.pg.model.PGSlide;
import com.github.axet.bookreader.office.simpletext.font.FontTypefaceManage;
import com.github.axet.bookreader.office.simpletext.model.AttrManage;
import com.github.axet.bookreader.office.simpletext.model.IAttributeSet;
import com.github.axet.bookreader.office.simpletext.model.LeafElement;
import com.github.axet.bookreader.office.simpletext.model.ParagraphElement;
import com.github.axet.bookreader.office.simpletext.model.SectionElement;
import com.github.axet.bookreader.office.ss.util.format.NumericFormatter;
import com.github.axet.bookreader.office.system.AbstractReader;
import com.github.axet.bookreader.office.system.BackReaderThread;
import com.github.axet.bookreader.office.system.IControl;
...
{   
    ...
    private com.github.axet.bookreader.office.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.github.axet.bookreader.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.github.axet.bookreader.office.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.github.axet.bookreader.office.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.github.axet.bookreader.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.github.axet.bookreader.office.java.awt.Color fillColor = fill.getForegroundColor();
            	com.github.axet.bookreader.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.github.axet.bookreader.office.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof com.github.axet.bookreader.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.github.axet.bookreader.office.fc.hslf.model.Freeform
            || shape instanceof com.github.axet.bookreader.office.fc.hslf.model.AutoShape
            || shape instanceof com.github.axet.bookreader.office.fc.hslf.model.TextBox
            || shape instanceof com.github.axet.bookreader.office.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.github.axet.bookreader.office.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.github.axet.bookreader.office.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.github.axet.bookreader.office.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.github.axet.bookreader.office.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof com.github.axet.bookreader.office.fc.hslf.model.AutoShape
                    || shape instanceof com.github.axet.bookreader.office.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.github.axet.bookreader.office.fc.hslf.model.Picture)
            {   
                com.github.axet.bookreader.office.fc.hslf.model.Picture poiPic = (com.github.axet.bookreader.office.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.github.axet.bookreader.office.fc.hslf.model.Table)
        {
            com.github.axet.bookreader.office.fc.hslf.model.Table poiTable = (com.github.axet.bookreader.office.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.github.axet.bookreader.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.github.axet.bookreader.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.github.axet.bookreader.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.github.axet.bookreader.office.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.github.axet.bookreader.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.github.axet.bookreader.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
        com.github.axet.bookreader.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.github.axet.bookreader.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.github.axet.bookreader.office.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
