...
import com.github.axet.bookreader.office.constant.DialogConstant;
...
import com.github.axet.bookreader.office.system.AbstractControl;
import com.github.axet.bookreader.office.system.IControl;
import com.github.axet.bookreader.office.system.IFind;
...
public class PGControl extends AbstractControl
{
     ...
     * 
     */
    public PGControl(IControl mainControl, PGModel pgModel, String filePath, OnChangePageDocumentListener onChangePageDocumentListener)
    {
        this.mainControl = mainControl;
        pgView = new Presentation(getMainFrame().getActivityIMain(), pgModel, this, onChangePageDocumentListener);
    }
    ...
    public void actionEvent(int actionID, final Object obj)
    {
        switch (actionID)
        {
            ...
            case EventConstant.PG_NOTE_ID:                          //show notes
                ...
                vector.add(text);
                new com.github.axet.bookreader.office.pg.dialog.NotesDialog(this, getMainFrame().getActivityIMain(), null, vector,
                    DialogConstant.SHOW_PG_NOTE_ID).show();
                break;
                
            case EventConstant.FILE_COPY_ID:                      //copy
                ClipboardManager clip = (ClipboardManager)getMainFrame().getActivityIMain().getSystemService(Context.CLIPBOARD_SERVICE);
            ...
            case EventConstant.APP_HYPERLINK: //hyperlink
                ...
                if(addr != null)
                {
                    try
                    {
                        ...
                        getMainFrame().getActivityIMain().startActivity(hyIntent);
                    }
                    catch(Exception e)
                    {
            ...
            case EventConstant.SYS_AUTO_TEST_FINISH_ID: // 布局完成 
                if (isAutoTest())
                {
                    getMainFrame().getActivityIMain().onBackPressed();
                }
                break;
...
//            safeAsyncTask.execute((Void)null);
    ...
    {
        return mainControl.getMainFrame().getActivityIMain();
    }
