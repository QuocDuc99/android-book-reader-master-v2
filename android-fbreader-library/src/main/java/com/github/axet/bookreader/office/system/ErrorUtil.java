...
import com.github.axet.bookreader.office.fc.OldFileFormatException;
...
public class ErrorUtil
{
    ...
    {
    	this.sysKit = syskit; 
    	if(syskit.getControl()==null || syskit.getControl().getMainFrame()== null) return;
    ...
    {   
        ...
        {
            sysKit.getControl().getMainFrame().getActivityIMain().onBackPressed();
        }
        catch (Exception eee)
        {
            return;
    ...
    private void processThrowable(final Throwable ex, final boolean isReaderFile)
    {
        ...
        final Activity activity = control.getMainFrame().getActivityIMain();
                ...
                {                 
                    try {
                        ...
                        if (err != null) {
                            ...
                            if (control.getMainFrame().isPopUpErrorDlg() && message == null) {
                                AlertDialog.Builder builder = new AlertDialog.Builder(activity);
                                builder.setMessage(control.getActivity().getResources().getString(R.string.error_file));
                                builder.setCancelable(false);
                                builder.setTitle(control.getMainFrame().getAppName());
                                String ok = control.getMainFrame().getLocalString("BUTTON_OK");
                                builder.setPositiveButton(ok, new DialogInterface.OnClickListener() {
...
//                            Utils.customToast(control.getActivity(),control.getActivity().getResources().getString(R.string.error_file));
