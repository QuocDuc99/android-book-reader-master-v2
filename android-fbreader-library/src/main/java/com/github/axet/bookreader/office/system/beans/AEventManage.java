 ...
 * 时间:              下午8:02:22
 */
package com.github.axet.bookreader.office.system.beans;
...
{    
    ...
    {
        if(control!=null ) return control.getMainFrame().onEventMethod(control.getView(), e, null, -1.0f, -1.0f, IMainFrame.ON_SINGLE_TAP_CONFIRMED) ;
        return false;
    }
