...
package com.github.axet.bookreader.office.fc.hslf.usermodel;
...
import com.github.axet.bookreader.office.fc.hslf.exceptions.CorruptPowerPointFileException;
import com.github.axet.bookreader.office.fc.hslf.model.HeadersFooters;
import com.github.axet.bookreader.office.fc.hslf.model.Hyperlink;
import com.github.axet.bookreader.office.fc.hslf.model.MovieShape;
...
import com.github.axet.bookreader.office.fc.hslf.record.Document;
import com.github.axet.bookreader.office.fc.hslf.record.DocumentAtom;
import com.github.axet.bookreader.office.fc.hslf.record.ExAviMovie;
import com.github.axet.bookreader.office.fc.hslf.record.ExControl;
import com.github.axet.bookreader.office.fc.hslf.record.ExHyperlink;
import com.github.axet.bookreader.office.fc.hslf.record.ExHyperlinkAtom;
import com.github.axet.bookreader.office.fc.hslf.record.ExMCIMovie;
import com.github.axet.bookreader.office.fc.hslf.record.ExObjList;
import com.github.axet.bookreader.office.fc.hslf.record.ExObjListAtom;
import com.github.axet.bookreader.office.fc.hslf.record.ExOleObjAtom;
import com.github.axet.bookreader.office.fc.hslf.record.ExVideoContainer;
import com.github.axet.bookreader.office.fc.hslf.record.ExtendedParagraphHeaderAtom;
import com.github.axet.bookreader.office.fc.hslf.record.ExtendedPresRuleContainer;
import com.github.axet.bookreader.office.fc.hslf.record.FontCollection;
import com.github.axet.bookreader.office.fc.hslf.record.HeadersFootersContainer;
import com.github.axet.bookreader.office.fc.hslf.record.PersistPtrHolder;
import com.github.axet.bookreader.office.fc.hslf.record.PositionDependentRecord;
...
import com.github.axet.bookreader.office.fc.hslf.record.RecordContainer;
import com.github.axet.bookreader.office.fc.hslf.record.RecordTypes;
import com.github.axet.bookreader.office.fc.hslf.record.SlideListWithText;
import com.github.axet.bookreader.office.fc.hslf.record.SlidePersistAtom;
import com.github.axet.bookreader.office.fc.hslf.record.ExtendedPresRuleContainer.ExtendedParaAtomsSet;
import com.github.axet.bookreader.office.fc.hslf.record.SlideListWithText.SlideAtomsSet;
    ...
    private void buildSlidesAndNotes()
    {
        ...
        if (masterSLWT != null)
        {
            ...
            for (int i = 0; i < masterSets.length; i++)
            {
                ...
                if (r instanceof com.github.axet.bookreader.office.fc.hslf.record.Slide)
                {
                    TitleMaster master = new TitleMaster((com.github.axet.bookreader.office.fc.hslf.record.Slide)r, sheetNo);
                    master.setSlideShow(this);
                    tmr.add(master);
                }
                else if (r instanceof com.github.axet.bookreader.office.fc.hslf.record.MainMaster)
                {
                    SlideMaster master = new SlideMaster((com.github.axet.bookreader.office.fc.hslf.record.MainMaster)r, sheetNo);
                    master.setSlideShow(this);
                    mmr.add(master);
                }
            }
        ...
        // notesSLWT
        com.github.axet.bookreader.office.fc.hslf.record.Notes[] notesRecords;
        SlideAtomsSet[] notesSets = new SlideAtomsSet[0];
        Hashtable<Integer, Integer> slideIdToNotes = new Hashtable<Integer, Integer>();
        if (notesSLWT == null)
        {
            // None
            notesRecords = new com.github.axet.bookreader.office.fc.hslf.record.Notes[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            notesSets = notesSLWT.getSlideAtomsSets();
            ArrayList<com.github.axet.bookreader.office.fc.hslf.record.Notes> notesRecordsL = new ArrayList<com.github.axet.bookreader.office.fc.hslf.record.Notes>();
            for (int i = 0; i < notesSets.length; i++)
            {
                ...
                if (r instanceof com.github.axet.bookreader.office.fc.hslf.record.Notes)
                {
                    com.github.axet.bookreader.office.fc.hslf.record.Notes notesRecord = (com.github.axet.bookreader.office.fc.hslf.record.Notes)r;
            ...
            notesRecords = new com.github.axet.bookreader.office.fc.hslf.record.Notes[notesRecordsL.size()];
            notesRecords = notesRecordsL.toArray(notesRecords);
        }

        // Now, do the same thing for our slides
        com.github.axet.bookreader.office.fc.hslf.record.Slide[] slidesRecords;
        SlideAtomsSet[] slidesSets = new SlideAtomsSet[0];
        if (slidesSLWT == null)
        {
            // None
            slidesRecords = new com.github.axet.bookreader.office.fc.hslf.record.Slide[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            slidesSets = slidesSLWT.getSlideAtomsSets();
            slidesRecords = new com.github.axet.bookreader.office.fc.hslf.record.Slide[slidesSets.length];
            for (int i = 0; i < slidesSets.length; i++)
            {
                ...
                if (r instanceof com.github.axet.bookreader.office.fc.hslf.record.Slide)
                {
                    slidesRecords[i] = (com.github.axet.bookreader.office.fc.hslf.record.Slide)r;
                }
                /*else
                {
