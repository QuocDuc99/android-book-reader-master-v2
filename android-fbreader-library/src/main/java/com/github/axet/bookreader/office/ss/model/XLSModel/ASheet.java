 ...
 * 时间:              下午1:55:20
 */
package com.github.axet.bookreader.office.ss.model.XLSModel;
...
import com.github.axet.bookreader.office.common.shape.AChart;
...
import com.github.axet.bookreader.office.constant.SSConstant;
import com.github.axet.bookreader.office.fc.hssf.model.InternalSheet;
import com.github.axet.bookreader.office.fc.hssf.model.InternalWorkbook;
import com.github.axet.bookreader.office.fc.hssf.record.BlankRecord;
import com.github.axet.bookreader.office.fc.hssf.record.CellValueRecordInterface;
import com.github.axet.bookreader.office.fc.hssf.record.DefaultRowHeightRecord;
...
import com.github.axet.bookreader.office.fc.hssf.record.RecordBase;
import com.github.axet.bookreader.office.fc.hssf.record.RowRecord;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFAutoShape;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFChart;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFChildAnchor;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFClientAnchor;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFFreeform;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFLine;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFPatriarch;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFPicture;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFPictureData;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFRichTextString;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFShape;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFShapeGroup;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFSheet;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFTextbox;
import com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFWorkbook;
import com.github.axet.bookreader.office.fc.hssf.util.HSSFPaneInformation;
import com.github.axet.bookreader.office.fc.ss.util.HSSFCellRangeAddress;
import com.github.axet.bookreader.office.fc.xls.ChartConverter;
import com.github.axet.bookreader.office.java.awt.Rectangle;
import com.github.axet.bookreader.office.ss.model.CellRangeAddress;
import com.github.axet.bookreader.office.ss.model.baseModel.Cell;
import com.github.axet.bookreader.office.ss.model.baseModel.Row;
import com.github.axet.bookreader.office.ss.model.baseModel.Sheet;
import com.github.axet.bookreader.office.ss.model.baseModel.Workbook;
import com.github.axet.bookreader.office.ss.model.drawing.AnchorPoint;
import com.github.axet.bookreader.office.ss.model.drawing.CellAnchor;
import com.github.axet.bookreader.office.ss.model.sheetProperty.PaneInformation;
import com.github.axet.bookreader.office.ss.util.ModelUtil;
import com.github.axet.bookreader.office.ss.util.SectionElementFactory;
...
import com.github.axet.bookreader.office.thirdpart.achartengine.chart.RoundChart;
import com.github.axet.bookreader.office.thirdpart.achartengine.chart.XYChart;
import com.github.axet.bookreader.office.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements com.github.axet.bookreader.office.fc.ss.usermodel.Sheet
{
     ...
     * @see com.github.axet.bookreader.office.fc.hssf.usermodel.HSSFWorkbook#createSheet()
     */
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.github.axet.bookreader.office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.github.axet.bookreader.office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.github.axet.bookreader.office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.github.axet.bookreader.office.ss.model.sheetProperty.ColumnInfo columnInfo = new com.github.axet.bookreader.office.ss.model.sheetProperty.ColumnInfo(
