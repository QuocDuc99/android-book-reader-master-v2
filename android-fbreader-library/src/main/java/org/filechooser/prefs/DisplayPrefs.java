...
public class DisplayPrefs extends Prefs {
     ...
     */
    public static FileChooserActivity.ViewType getViewType(Context c) {
        return FileChooserActivity.ViewType.Listed.ordinal() == p(c).getInt(c.getString(R.string.afc_pkey_display_view_type),
                c.getResources().getInteger(R.integer.afc_pkey_display_view_type_def)) ? FileChooserActivity.ViewType.Listed : FileChooserActivity.ViewType.Grid;
    }
     ...
     */
    public static void setViewType(Context c, FileChooserActivity.ViewType v) {
     ...
     */
    public static IFileProvider.SortType getSortType(Context c) {
        for (IFileProvider.SortType s : IFileProvider.SortType.values())
     ...
     */
    public static void setSortType(Context c, IFileProvider.SortType v) {
