...
package org.filechooser.utils.ui;
...
import org.filechooser.IFileAdapter;
import org.filechooser.IFileDataModel;
...
public class ViewFilesContextMenuUtils {
    ...
    public static void doShowHistoryContents(final Context context, final IFileProvider fileProvider,
        ...
        final IFileAdapter
                _adapter = new IFileAdapter(context, data, IFileProvider.FilterMode.DirectoriesOnly, null, false);
