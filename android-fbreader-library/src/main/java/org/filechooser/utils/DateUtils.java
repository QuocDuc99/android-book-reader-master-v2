...
public class DateUtils {
     ...
     */
    public static String formatDate(Context context, long millis, DisplayPrefs.FileTimeDisplay fileTimeDisplay) {
     ...
     */
    public static String formatDate(Context context, Calendar date, DisplayPrefs.FileTimeDisplay fileTimeDisplay) {
