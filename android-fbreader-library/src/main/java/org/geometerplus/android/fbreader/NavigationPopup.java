...
public final class NavigationPopup extends ZLApplication.PopupPanel {
    ...
    private ListenNaviPopup mListenNaviPopup;
    private volatile boolean myIsInProgress;

    public void setListenNaviPopup(ListenNaviPopup listenNaviPopup) {
        mListenNaviPopup = listenNaviPopup;
    }
...
//        }
    ...
    private String makeProgressText(int page, int pagesNumber) {
        ...
        if (tocElement != null) {
            ...
            Log.d("ducNQ", "makeProgressText: " + tocElement.getText());
        }

        if (mListenNaviPopup != null) {
            mListenNaviPopup.actionReloadBookmark();
        }
    ...
    public interface ListenNaviPopup {
