...
public abstract class ZLApplication {
    ...
    private ListenZLApplication mListenZLApplication;

    public void setListenZLApplication(ListenZLApplication listenZLApplication) {
        mListenZLApplication = listenZLApplication;
    }
    ...
    //scroll page book view
    public final void onRepaintFinished() {
        if (myWindow != null) {
            myWindow.refresh();
        }
        if (mListenZLApplication != null) {
            mListenZLApplication.loadPage();
        }
    ...
    public interface ListenZLApplication {
        void loadPage();
    }
}
