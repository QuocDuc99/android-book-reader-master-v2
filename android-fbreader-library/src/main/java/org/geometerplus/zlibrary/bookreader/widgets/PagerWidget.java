...
public class PagerWidget extends ZLAndroidWidget {
    ...
    private ListenFull mListenFull;
    ...
    public void setListenFull(ListenFull listenFull) {
        mListenFull = listenFull;
    }
