...
import org.geometerplus.zlibrary.bookreader.activities.BookActivity;
import org.geometerplus.zlibrary.bookreader.app.BookApplication;
import org.geometerplus.zlibrary.bookreader.app.Storage;
import org.geometerplus.zlibrary.bookreader.widgets.BookmarksDialog;
...
public class LibraryFragment extends Fragment implements BookActivity.SearchListener {
    ...
    public static class FragmentHolder {
        ...
        public void updateGrid() {
            ...
            if (shared.getString(BookApplication.PREFERENCE_LIBRARY_LAYOUT + getLayout(), "")
                    .equals("book_list_item")) {
                setNumColumns(1);
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            if (id == R.id.action_grid) {
                ...
                if (layout == R.layout.book_list_item) {
                    editor.putString(BookApplication.PREFERENCE_LIBRARY_LAYOUT + getLayout(),
                            "book_item");
                } else {
                    editor.putString(BookApplication.PREFERENCE_LIBRARY_LAYOUT + getLayout(),
                            "book_list_item");
        ...
        public void setNumColumns(int i) {
            ...
            if (i == 1) {
                ...
                if (l == null || l instanceof GridLayoutManager) reset = lm;
            } else {
                ...
                RecyclerView.LayoutManager l = grid.getLayoutManager();
                if (l == null
                        || !(l instanceof GridLayoutManager)
                        || ((GridLayoutManager) l).getSpanCount() != i) {
                    reset = lm;
                }
            }
    ...
    public class LibraryAdapter extends BooksAdapter {
        ...
        public void sort() {
            ...
            int selected = getContext().getResources()
                    .getIdentifier(shared.getString(BookApplication.PREFERENCE_SORT,
                                    getContext().getResources().getResourceEntryName(R.id.sort_add_ask)),
        ...
        public Bitmap downloadImageTask(CacheImagesAdapter.DownloadImageTask task) {
            ...
            try {
                ...
                if (!cover.exists() || cover.length() == 0) storage.createCover(fbook, cover);
                book.cover = cover;
                try {
        ...
        @Override
        public void downloadTaskUpdate(CacheImagesAdapter.DownloadImageTask task, Object item,
                Object view) {
    ...
    public static abstract class BooksAdapter
            extends CacheImagesRecyclerAdapter<BooksAdapter.BookHolder> {
        String filter;
        FragmentHolder holder;
            ...
            h.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (holder.longClickListener != null) {
                        holder.longClickListener.onItemLongClick(null, v, h.getAdapterPosition(),
                                -1);
                    }
                    return true;
                }
        ...
        void setText(TextView t, String s) {
            if (t == null) return;
            TextMax m = null;
            if (t.getParent() instanceof TextMax) m = (TextMax) t.getParent();
            ViewParent p = t.getParent();
            if (s == null || s.isEmpty()) {
                t.setVisibility(View.GONE);
                if (m != null) m.setVisibility(View.GONE);
                return;
            }
            t.setVisibility(View.VISIBLE);
            t.setText(s);
            if (m != null) m.setVisibility(View.VISIBLE);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        holder.grid.setAdapter((RecyclerView.Adapter) books);
        holder.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                main.loadBook(b);
                // Uri uri = Uri.parse("https://cdn-file.thuvien.edu.vn/Uploads/THU_VIEN/shn/3/1823/UserFiles/TV5-2-5d70c0b3-08c8-4b60-bc8e-6d4dbeeb7c60.pdf");
                // Uri uri = Uri.parse(
                // "https://media-dev.thuvien.edu.vn/vie_lib/Uploads/THU_VIEN/shn/2/931/UserFiles/Lich-su-viet-nam-bang-tranh-tap-6-57d00a16-96ae-4de6-a31d-76b54ebb5dc2.pdf")
                ;
                // Uri uri = Uri.parse("https://cdn-file.thuvien.edu.vn/Uploads/THU_VIEN/shn/3/1823/UserFiles/61-20200316111251-dao-duc-4-new-73bd9cce-2629-454c-9031-758c32cb982a.pdf");

                 //main.loadBook(uri, null);
            }
        });
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.action_rename) {
                            final OpenFileDialog.EditTextDialog e =
                                    new OpenFileDialog.EditTextDialog(getContext());
                        ...
                        if (item.getItemId() == R.id.action_share) {
                            ...
                            Intent share =
                                    StorageProvider.getProvider().shareIntent(b.url, t, type, t);
                            startActivity(share);
                        }
    ...
    public void onCreateOptionsMenu(final Menu menu, MenuInflater inflater) {
        ...
        int selected = getContext().getResources()
                .getIdentifier(shared.getString(BookApplication.PREFERENCE_SORT,
                                getContext().getResources().getResourceEntryName(R.id.sort_add_ask)), "id",
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        SharedPreferences shared = PreferenceManager.getDefaultSharedPreferences(getContext());
        int id = item.getItemId();
        if (id == R.id.sort_add_ask
                || id == R.id.sort_add_desc
                || id == R.id.sort_name_ask
                || id == R.id.sort_name_desc
                || id == R.id.sort_open_ask
                || id == R.id.sort_open_desc) {
            shared.edit()
                    .putString(BookApplication.PREFERENCE_SORT,
                            getContext().getResources().getResourceEntryName(item.getItemId()))
                    .commit();
            books.sort();
            invalidateOptionsMenu.run();
            return true;
