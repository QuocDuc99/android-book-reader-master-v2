        ...
        public void onBindViewHolder(final BMHolder h, int position) {
            ...
            h.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Storage.Bookmark n =
                            (Storage.Bookmark) getItem(h.getAdapterPosition(BMAdapter.this)).tag;
                    onSelected(n);
                    dialog.dismiss();
                }
            });
                    ...
                    menu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            if (id == R.id.action_edit) {
                                BookmarkPopup popup =
                                        new BookmarkPopup(h.itemView, tt, new ArrayList<View>()) {
                                            @Override
            ...
            if (t.tag instanceof Storage.Bookmark) {
                ...
                h.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Storage.Bookmark n = (Storage.Bookmark) getItem(
                                h.getAdapterPosition(BMAdapterBooks.this)).tag;
                        onSelected(tt, n);
                        dialog.dismiss();
                    }
                });
